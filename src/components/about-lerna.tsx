    ...
    <section className="padding-vert--xl container">
      <div className={clsx("row margin-bottom--xl", styles.hero)}>
        <div className="col col--8">
          <div>
            <h1 className={clsx("margin-bottom--lg", styles.hero__title)}>Why BrowZer?</h1>
            <p className={clsx("margin-bottom--md", styles.hero__text)}>
              BrowZer lets you develop your web application the way you always have, which is fantastic for
              productivity. You can then deploy to a 'dark' cloud instance, and use OpenZiti to establish air-tight zero trust security.
              That is why more and more teams are switching to this type of deployment.
            </p>
            <p className={clsx("margin-bottom--md", styles.hero__text)}>
              To secure web applications well, you need a world-class zero trust system, and OpenZiti BrowZer is exactly that. 
              <br/>
              <br/>
              <a href="https://github.com/openziti/ziti">OpenZiti</a> is widely used, and battle tested.
            </p>
          </div>
        </div>
      </div>
